...
public class ReflectionApi {
    ...
    private static void m12() throws Exception {
        URL[] folderUrls = {new URL("file:\\src\\ru\\davidlevy\\lesson7\\classwork\\")};
        Class c = URLClassLoader.newInstance(folderUrls).loadClass("ru.davidlevy.lesson7.classwork.Unknown");
    ...
    private static void m11() throws Exception {
        ...
        // Получим:
        // private java.lang.String ru.davidlevy.lesson7.classwork.ReflectionApi$Dog.voice()
    ...
    private static void m7() {
        ...
        for (Field o : fields1)
            System.out.println(o);
        // Только:
        // b. public int ru.davidlevy.lesson7.MainClass$Dog.b
        ...
        for (Field o : fields2)
            System.out.println(o);
        // Только:
        // public int ru.davidlevy.lesson7.MainClass$Dog.b
        // private int ru.davidlevy.lesson7.MainClass$Dog.c
        ...
        for (Field o : fields3)
            System.out.println(o);
        // Только:
        // private int ru.davidlevy.lesson7.MainClass$Animal.a
    }
    ...
    private static void m4() throws Exception {
        ...
        // Получим:
        // info with @ru.davidlevy.lesson7.classwork.MyAnnotation(data=23, order=10)
        // voice with @ru.davidlevy.lesson7.classwork.MyAnnotation(data=5, order=10)
